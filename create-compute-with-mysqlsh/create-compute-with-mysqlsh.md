...
## Task 4: Connect to your Compute Instance
...
## Task 5: Install MySQL Shell

1. You will need a MySQL client tool to connect to your new MySQL DB System from your client machine.

    Obtain the RPM of MySQL Shell 8.3 with the following command 

    **[opc@…]$**

     ```bash
    <copy>wget  https://dev.mysql.com/get/Downloads/MySQL-Shell/mysql-shell-8.3.0-1.el8.x86_64.rpm</copy>
    ```
   

   Install it with the following command (enter y for each question)

    **[opc@…]$**

     ```bash
    <copy>sudo yum localinstall mysql-shell-8.3.0-1.el8.x86_64.rpm</copy>
    ```

    ![MySQL Shell Install](./images/install-shell.png "connect shell")
